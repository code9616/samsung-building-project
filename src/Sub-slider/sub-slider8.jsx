...
import styles from "../Sub-slider/sub-slider8.module.css";
// yarn 일때
...
function SampleNextArrow(props) {
    ...
    return (
        <img
            ...
            id="right"
            className={className}
            style={{ ...style, display: "block", right: "35px", width: "30px", height: "50px" }}
            onClick={onClick}
            src={wArrowRight}
        />
    );
...
function SamplePrevArrow(props) {
    ...
    return (
        <img
            ...
            id="left"
            className={className}
            style={{ ...style, display: "block", left: "455px", zIndex: "1", width: "30px", height: "50px" }}
            onClick={onClick}
            src={wArrowLeft}
        />
    );
